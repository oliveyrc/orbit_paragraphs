...
| Module | Section machine name | Title | Description | Thumbnail |
| --- | --- | --- | --- | --- |
| `orbit_paragraphs_text` | `orbit_paragraphs_text` | Text | Text section with optional title. | ![Text thumbnail](modules/orbit_paragraphs_text/assets/thumbnail.png) |
| `orbit_paragraphs_image` | `orbit_paragraphs_inline_image` | Inline Image | Inline image with optional title and intro paragraph. | ![Inline Image thumbnail](modules/orbit_paragraphs_image/assets/thumbnail.png) |
